      ...
      <div className="flex flex-row items-start gap-3">
        ...
        <div>
          <div className="flex flex-row items-center gap-2">
            ...
            <span
              onClick={goToUser}
              className="text-neutral-400 cursor-pointer hover:underline hidden lg:block"
            >
          ...
          <div className="flex flex-row items-center mt-3 gap-10">
            ...
            {currentUser?.id === data.authorId && (
              <div
                ...
                className="flex flex-row items-center text-neutral-400 gap-2 cursor-pointer transition hover:text-rose-500"
              >
